...
names(r4ds_members) <- c('Messages in public channels', 'Messages in private channels',
                         'Messages in shared channels', 'messages in Direct Messages',
                         'date')
...
r4ds_long <- gather(r4ds_members, message_type, total, 
